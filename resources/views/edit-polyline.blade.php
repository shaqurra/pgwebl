    ...
    <div class="modal fade" id="editpolylineModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form id="editPolylineForm" method="POST" action="{{ route('polyline.update', $id) }}"
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <img src="" alt="" id="preview-image-polyline" class="img-thumbnail mt-3"
                                width="400">
                        </div>
                    </div>
    ...
    <script>
        ...
        map.on('draw:edited', function(e) {
            ...
            layers.eachLayer(function(layer) {
                ...
                // Fokuskan peta ke geometri yang diedit
                map.fitBounds(layer.getBounds());

                // Update modal fields untuk POLYLINE
                ...
                var updateUrl = "{{ route('polyline.update', ':id') }}";
                updateUrl = updateUrl.replace(':id', properties.id);
                $('#editPolylineForm').attr('action', updateUrl);
        ...
        var polyline = L.geoJson(null, {
            onEachFeature: function(feature, layer) {
                //memasukkan layer polyline ke dalam drawItems
